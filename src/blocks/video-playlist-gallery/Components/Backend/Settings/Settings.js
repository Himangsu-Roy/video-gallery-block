...
const Settings = ({ attributes, setAttributes, activeIndex, setActiveIndex, isPremium, setIsProModalOpen,device }) => {
	...
	return <>
		<InspectorControls>
			...
			<TabPanel className='bPlTabPanel wp-block-vpg-video-playlist-gallery-test-purpose' activeClass='activeTab'
				tabs={generalStyleTabs}
				onSelect={tabController}
			>
				{
					tab => <>
						{'general' === tab.name && <General attributes={attributes} setAttributes={setAttributes} activeIndex={activeIndex}
							setActiveIndex={setActiveIndex}
							premiumProps={premiumProps} device={device} />}

						{'style' === tab.name && <Style attributes={attributes} setAttributes={setAttributes} activeIndex={activeIndex}
							setActiveIndex={setActiveIndex}
							premiumProps={premiumProps} device={device} />}
					</>
				}
